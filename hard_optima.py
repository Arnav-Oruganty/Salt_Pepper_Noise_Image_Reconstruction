...
print("--- Running Optimal Value and Time Analysis for HARD Problem ---")
...
for noise_level, lambda_val in OPTIMA_PAIRS.items():
    ...
    for filename in image_files:
        ...
        obj_val, solve_time, X_recon = solve_hard_problem(X_corr, lambda_val)
...
print("\nDone. Optimal images saved in 'optima/hard/'.")
